...
class CourtReservation:
    def __init__(self, name: str = None, startdate: datetime = None, duration: timedelta = None):
        self.name = name
        self.startdate = startdate
        self.duration = duration

    def __str__(self):
        return f'* {self.name} {self.startdate} - {self.startdate + self.duration}'
    ...
    def input_name(self):
        ...
        self.name = bookername

    def input_date(self, inputprompt, validationprompt):
        while True:
        ...
        self.startdate = reservationdate
    ...
    def input_duration(self):
        ...
        self.duration = reservationtduration
